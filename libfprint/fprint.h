...
/* Print discovery */
struct fp_dscv_print **fp_discover_prints(char *path, char *user);
...
int fp_print_data_load(struct fp_dev *dev, enum fp_finger finger,
	struct fp_print_data **data, char *path, char *user);
int fp_print_data_from_dscv_print(struct fp_dscv_print *print,
	struct fp_print_data **data);
int fp_print_data_save(struct fp_print_data *data, enum fp_finger finger, char *path, char *user);
